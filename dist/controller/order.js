...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, deliveryAddress, orderItems, totalPrice, user, totalAmount, paymentIntent, order, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, deliveryAddress = _a.deliveryAddress, orderItems = _a.orderItems, totalPrice = _a.totalPrice, user = _a.user;
            ...
            case 3:
                error_1 = _b.sent();
                console.log(error_1, 'Something wrong while creating Order');
