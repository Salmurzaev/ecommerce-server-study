...
exports.getProductsById = exports.getProducts = exports.createProduct = void 0;
...
var createProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, image = _a.image, name = _a.name, price = _a.price, description = _a.description;
            ...
            case 2:
                error_1 = _b.sent();
                console.log(error_1, 'Something wrong while creating Product');
...
var getProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.log(error_2, 'Something wrong while getting Products');
...
var getProductsById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                console.log(error_3, 'Something wrong while getting Product');
